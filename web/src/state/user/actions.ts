...
export const updateHideLowValuePositions = createAction<{ userHideLowValuePositions: boolean }>('user/hideLowValuePositions')
export const updateLowValuePositionThreshold = createAction<{ lowValueThreshold: number }>('user/updateLowValuePositionThreshold')
