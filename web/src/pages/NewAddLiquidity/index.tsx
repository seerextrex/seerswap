...
export function NewAddLiquidityPage({
    ...
    }, [mintInfo, startPriceTypedValue, account]);
    ...
    const completedSteps = useMemo(() => {
        return Array(currentStep).fill(0).map((_, i) => i + 1);
    }, [currentStep]);
    ...
    }, [mintInfo, currentStep, stepInitialPrice, usdPriceA, usdPriceB, initialUSDPrices]);
