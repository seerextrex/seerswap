...
export default function FarmingPage() {
    ...
    return (
        <>
            <Helmet>
                <title>{t`SeerSwap — Farming`}</title>
            </Helmet>
            <Card classes={"br-24 p-2 mm_p-1"}>
                ...
                <Switch>
                    ...
                    <Route exact path={`${path}/farms`}>
                        <Helmet>
                            <title>{t`SeerSwap — Farming • My Farms`}</title>
                        </Helmet>
                        {account ? (
                            <>
                    ...
                    {/* <Route exact path={`${path}/limit-farms`}>
                        <Helmet>
                            <title>{t`SeerSwap — Farming • Limit Farms`}</title>
                        </Helmet>
                    ...
                    {/* <Route exact strict path={`${path}/farms-history`}>
                        <Helmet>
                            <title>{t`SeerSwap — Farming • Farms History history`}</title>
                        </Helmet>
                        <EventsHistory />
                    </Route> */}
                </Switch>
