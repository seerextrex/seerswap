...
export type MarketQuery = (
  ...
  & { market?: Maybe<(
    ...
    & { collateralToken: (
      ...
      & { question: (
        { __typename?: 'Question' }
        & Pick<Question, 'id' | 'best_answer' | 'is_pending_arbitration' | 'finalize_ts'>
      ) }
    )>, image: Array<(
      { __typename?: 'Image' }
...
export type MarketPoolHourDataQueryVariables = Exact<{
  pool: Scalars['ID'];
...
export type MarketPoolHourDataQuery = (
  { __typename?: 'Query' }
  & { poolHourDatas: Array<(
    { __typename?: 'PoolHourData' }
...
export type GetMarketPoolsQueryVariables = Exact<{
  marketId: Scalars['String'];
}>;


export type GetMarketPoolsQuery = (
  { __typename?: 'Query' }
  & { pools: Array<(
    { __typename?: 'Pool' }
    ...
    & { token0: (
      ...
      { __typename?: 'Market' }
      & Pick<Market, 'id' | 'marketName' | 'outcomes' | 'conditionId' | 'parentCollectionId' | 'wrappedTokensString'>
      & { collateralToken: (
        { __typename?: 'Token' }
        & Pick<Token, 'id' | 'symbol' | 'name' | 'decimals'>
      ) }
...
export type MarketPoolsWithPricesQueryVariables = Exact<{
  marketId: Scalars['String'];
}>;


export type MarketPoolsWithPricesQuery = (
  { __typename?: 'Query' }
  & { pools: Array<(
    { __typename?: 'Pool' }
    ...
    & { token0: (
      ...
      { __typename?: 'Market' }
      & Pick<Market, 'id' | 'wrappedTokensString'>
      & { collateralToken: (
        { __typename?: 'Token' }
        & Pick<Token, 'id'>
      ) }
...
export type HistoricalPoolDataQueryVariables = Exact<{
  poolId: Scalars['ID'];
  timestamp: Scalars['Int'];
}>;


export type HistoricalPoolDataQuery = (
  { __typename?: 'Query' }
  & { poolHourDatas: Array<(
    { __typename?: 'PoolHourData' }
    & Pick<PoolHourData, 'token0Price' | 'token1Price'>
  )> }
);
...
export type UserFarmingPositionsQueryVariables = Exact<{
  user: Scalars['Bytes'];
  first?: Maybe<Scalars['Int']>;
  skip?: Maybe<Scalars['Int']>;
}>;
...
export type UserFarmingPositionsQuery = (
  { __typename?: 'Query' }
  & { deposits: Array<(
    { __typename?: 'Deposit' }
    & Pick<Deposit, 'id' | 'owner' | 'L2tokenId' | 'liquidity' | 'onFarmingCenter'>
    & { eternalFarming?: Maybe<(
      { __typename?: 'EternalFarming' }
      & Pick<EternalFarming, 'id'>
    )>, limitFarming?: Maybe<(
      ...
      { __typename?: 'Pool' }
      & Pick<Pool, 'id' | 'fee' | 'sqrtPrice' | 'liquidity' | 'tick' | 'totalValueLockedUSD'>
      & { token0: (
        { __typename?: 'Token' }
        & Pick<Token, 'id' | 'symbol' | 'decimals' | 'derivedMatic'>
      ), token1: (
...
export type PositionsByIdsQueryVariables = Exact<{
  ids: Array<Scalars['ID']> | Scalars['ID'];
}>;


export type PositionsByIdsQuery = (
  { __typename?: 'Query' }
  & { positions: Array<(
    { __typename?: 'Position' }
    & Pick<Position, 'id' | 'liquidity' | 'depositedToken0' | 'depositedToken1' | 'withdrawnToken0' | 'withdrawnToken1' | 'collectedFeesToken0' | 'collectedFeesToken1' | 'token0Tvl' | 'token1Tvl' | 'feeGrowthInside0LastX128' | 'feeGrowthInside1LastX128'>
    & { tickLower: (
      { __typename?: 'Tick' }
      & Pick<Tick, 'tickIdx'>
    ), tickUpper: (
...
export type UserPositionsQuery = (
  ...
  & { positions: Array<(
    { __typename?: 'Position' }
    & Pick<Position, 'id' | 'owner' | 'liquidity' | 'depositedToken0' | 'depositedToken1' | 'withdrawnToken0' | 'withdrawnToken1' | 'collectedFeesToken0' | 'collectedFeesToken1' | 'token0Tvl' | 'token1Tvl' | 'feeGrowthInside0LastX128' | 'feeGrowthInside1LastX128'>
    & { pool: (
      { __typename?: 'Pool' }
      & Pick<Pool, 'id' | 'fee' | 'sqrtPrice' | 'liquidity' | 'tick' | 'totalValueLockedUSD'>
      & { token0: (
...
export type InfiniteFarmsQuery = (
  ...
  & { eternalFarmings: Array<(
    { __typename?: 'EternalFarming' }
    & Pick<EternalFarming, 'id' | 'rewardToken' | 'endTimeImplied' | 'totalAmountUSDEstimated' | 'rewardReserve' | 'bonusRewardToken' | 'startTime' | 'endTime' | 'reward' | 'bonusReward' | 'rewardRate' | 'bonusRewardRate' | 'tokenAmountForTier1' | 'tokenAmountForTier2' | 'tokenAmountForTier3' | 'tier1Multiplier' | 'tier2Multiplier' | 'tier3Multiplier' | 'multiplierToken'>
    & { pool: (
      { __typename?: 'Pool' }
      & Pick<Pool, 'id'>
      & { market0?: Maybe<(
...
export type FetchPoolsForMarketsQueryVariables = Exact<{
  marketIds: Array<Scalars['String']> | Scalars['String'];
  first?: Maybe<Scalars['Int']>;
  skip?: Maybe<Scalars['Int']>;
}>;


export type FetchPoolsForMarketsQuery = (
  { __typename?: 'Query' }
  & { pools: Array<(
    { __typename?: 'Pool' }
    & Pick<Pool, 'id' | 'fee' | 'liquidity' | 'sqrtPrice' | 'tick' | 'totalValueLockedUSD' | 'volumeUSD' | 'feesUSD'>
    & { token0: (
      ...
      { __typename?: 'Market' }
      & Pick<Market, 'id' | 'outcomes' | 'marketName' | 'finalizeTs' | 'payoutReported' | 'conditionId' | 'parentCollectionId' | 'lowerBound' | 'upperBound' | 'wrappedTokensString'>
      & { collateralToken: (
        { __typename?: 'Token' }
        & Pick<Token, 'id' | 'symbol' | 'name' | 'decimals'>
      ), wrappedTokens: Array<(
...
export const MarketPoolsDocument = `
  ...
  pools(
    ...
    `;
export const MarketPoolHourDataDocument = `
...
export const LastPoolDayDataDocument = `
  ...
  poolDayDatas(
    ...
    `;
export const GetMarketPoolsDocument = `
  ...
  pools(
    ...
    `;
export const MarketPoolsWithPricesDocument = `
  ...
  pools(
    ...
    `;
export const HistoricalPoolDataDocument = `
    query HistoricalPoolData($poolId: ID!, $timestamp: Int!) {
  poolHourDatas(
    first: 1
    where: {pool_: {id: $poolId}, periodStartUnix_lte: $timestamp}
    orderBy: periodStartUnix
    orderDirection: desc
  ) {
    token0Price
...
export const FullPositionsPriceRangeDocument = `
  ...
  q2: positions(where: {id_in: $positions}) {
    ...
    `;
export const UserFarmingPositionsDocument = `
    query userFarmingPositions($user: Bytes!, $first: Int = 100, $skip: Int = 0) {
  deposits(
    where: {owner: $user, onFarmingCenter: true}
    first: $first
    skip: $skip
    orderBy: id
    orderDirection: desc
    ...
    `;
export const PositionsByIdsDocument = `
...
export const PopularPoolsDocument = `
  ...
  pools(orderBy: totalValueLockedUSD, orderDirection: desc, first: 6) {
    ...
    `;
export const FetchPoolsForMarketsDocument = `
    query fetchPoolsForMarkets($marketIds: [String!]!, $first: Int = 1000, $skip: Int = 0) {
  pools(
    first: $first
    skip: $skip
    where: {or: [{market0_in: $marketIds}, {market1_in: $marketIds}]}
    orderBy: totalValueLockedUSD
    orderDirection: desc
  ) {
    id
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    MarketPools: build.query<MarketPoolsQuery, MarketPoolsQueryVariables>({
      query: (variables) => ({ document: MarketPoolsDocument, variables })
    }),
    ...
    MarketPoolsWithPrices: build.query<MarketPoolsWithPricesQuery, MarketPoolsWithPricesQueryVariables>({
      query: (variables) => ({ document: MarketPoolsWithPricesDocument, variables })
    }),
    HistoricalPoolData: build.query<HistoricalPoolDataQuery, HistoricalPoolDataQueryVariables>({
      query: (variables) => ({ document: HistoricalPoolDataDocument, variables })
    }),
    ...
    userFarmingPositions: build.query<UserFarmingPositionsQuery, UserFarmingPositionsQueryVariables>({
      query: (variables) => ({ document: UserFarmingPositionsDocument, variables })
    }),
    positionsByIds: build.query<PositionsByIdsQuery, PositionsByIdsQueryVariables>({
      query: (variables) => ({ document: PositionsByIdsDocument, variables })
    }),
    userPositions: build.query<UserPositionsQuery, UserPositionsQueryVariables>({
      query: (variables) => ({ document: UserPositionsDocument, variables })
    }),
